...
The project is based on continuity through change rather than sameness.

> Evolution does not imply progression.  
> Evolution is optional. Continuity is not.

See `CANONICAL_SPEC.md` for the complete specification and `manifest.json` for machine-readable metadata.
